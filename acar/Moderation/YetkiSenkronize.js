...
module.exports = {
    ...
    Kullanim: "yetkisenkronize <@Carry/ID> <Yetki S.Kodu>",
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!uye) return message.channel.wsend(cevaplar.üye + ` \`${sistem.prefix}${module.exports.Isim} u <@Carry/ID> <Yetki Numarası>\``).then(x => x.delete({timeout: 5000}));
    ...
    if(isNaN(yetkiKodu)) return message.channel.wsend(cevaplar.argümandoldur + ` \`${sistem.prefix}${module.exports.Isim} <@Carry/ID> <Yetki S.Numarası>\``);
