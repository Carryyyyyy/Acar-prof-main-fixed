...
module.exports = {
    Isim: "isim",
    Komut: ["i","nick"],
    Kullanim: "isim <@Carry/ID> <İsim> <Yaş>",
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!uye) return message.channel.wsend(cevaplar.üye + ` \`${sistem.prefix}${module.exports.Isim} <@Carry/ID> <Isim> <Yaş>\``);
    ...
    if(!isim || !yaş) return message.channel.wsend(cevaplar.argümandoldur + ` \`${sistem.prefix}${module.exports.Isim} <@Carry/ID> <Isim> <Yaş>\``);
    ...
    ${isimler}\n\nKişinin önceki isimlerine \`${sistem.prefix}isimler @Carry/ID\` komutuyla bakarak kayıt işlemini\n gerçekleştirmeniz önerilir.`)
