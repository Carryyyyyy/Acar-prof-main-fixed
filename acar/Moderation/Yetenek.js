...
module.exports = {
    Isim: "yetenek",
    Komut: ["yetenek"],
    Kullanim: "yetenek @Carry/ID <Yetenek İsmi>",
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if (!uye) return message.channel.wsend(`Hata: yetenek rolü verebilmem için lütfen bir üyeyi etiketle __Örn:__ \`${sistem.prefix}${module.exports.Isim} @Carry /ID <Yetenek İsmi>\`!`).then(x => x.delete({timeout: 5000}));
    ...
    if(args[1] !== "vokal" && args[1] !== "Vokal" && 
       ...
       ) return message.channel.wsend(embed.setFooter(ayarlar.embed.altbaşlık + ` • Örn; '${sistem.prefix}${module.exports.Isim} @Carry /ID müzisyen'`).setDescription(`Yetenek ismi belirlenmedi! lütfen aşağıdaki gibi yetenek ismi belirleyin! \`\`\`• Vokal\n• Müzisyen\n• Telli\n• Yazılımcı\n• Yayıncı\n• Tasarımcı\n• Ressam\n• Şair\`\`\``));
